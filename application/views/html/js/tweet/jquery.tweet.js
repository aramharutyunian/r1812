(function($) {
  ...
  $.fn.tweet = function(o){
    ...
    function build_url() {
      ...
      if (s.list) {
        return proto+"//"+s.twitter_api_url+"/1/"+s.username[0]+"/lists/"+s.list+"/="+count+"&callback=?";
      } else if (s.favorites) {
        return proto+"//"+s.twitter_api_url+"/favorites/"+s.username[0]+".json?count="+s.count+"&callback=?";
      } else if (s.query === null && s.username.length == 1) {
        return proto+'//'+s.twitter_api_url+'/='+s.username[0]+'&count='+count+'&include_rts=1&callback=?';
      } else {
