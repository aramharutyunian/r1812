    ...
    <div class="wrapper clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="fullwidth-content">
                ...
                <p><?php echo I18n::get('admin.label.add_news'); ?></p>
                <form method="post" class="form" action="<?php echo Kohana::$base_url . "private/news/do_add"; ?>"  enctype="multipart/form-data">
                    <fieldset>

                        <input name="image" type="file" id="imageUploadBrowse" style="position:absolute; top:-10000px;"/>

                        <div>
                            <input  type="hidden"  name="id"  value="<?php if(!empty($news['id'])) echo $news['id']    ?>"/>
                        ...
                        <div>
                            ...
                            <input name="title" type="text" class="form-poshytip" value="<?php if(!empty($news['name'])) echo $news['name']; ?>" title="<?php echo I18n::get('admin.label.name'); ?>" />
                            

                            <label id = "dateP"><?php echo I18n::get('admin.label.date');?></label>
                            <input name="datePicker" id="datepicker" class="form-poshytip" type="text" value="<?php if(!empty($news['date_of_creation'])) echo "$news[date_of_creation]"; ?>" title="<?php echo I18n::get('admin.label.date'); ?>"/>
                        </div>
                        <fieldset class="radios  inner">
                            <label class="label_radio label" for="radio-01"><input name="published" id="radio-01" value="1" type="radio" <?php if(empty($news['isPublished'])) echo "checked"; else if($news['isPublished'] == 1) echo "checked"; ?> /><?php echo I18n::get('admin.label.published'); ?></label>
                            <label class="label_radio label" for="radio-02"><input name="published" id="radio-02" value="0" type="radio" <?php if(!empty($news['isPublished']) && $news['isPublished'] == 0) echo "checked"; ?> /><?php echo I18n::get('admin.label.not_published'); ?></label>
                        </fieldset>
                        <div>
                            <textarea id="content" name="elm1" rows="15" cols="80" style="width: 80%" class="tinymce">
                                <?php if(!empty($news['content'])) echo $news['content']; ?>
                            </textarea>
                            <p>
