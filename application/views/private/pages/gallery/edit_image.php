    ...
    <div class="wrapper clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="fullwidth-content">
                ...
                <form method="post" class="form" action="<?php echo Kohana::$base_url . "private/gallery/do_edit_image"; ?>"  enctype="multipart/form-data">
                    <fieldset>
                        <?php if ($image['src'] != NULL) { ?>
                        <img  src="<?php echo Kohana::$base_url ?>media/resources/gallery/<?php echo $image['album_id'] . "/" . $image['src']; ?>"
                              class="editor_thumb"/>
                        <?php } ?>
                        ...
                        <div>
                            ...
                            <input  type="hidden"  name="id"  value="<?php if(!empty($image['id'])) echo $image['id'] ?>"/>
                            <input  type="hidden"  name="src"  value="<?php if (!empty( $image['src']))echo $image['src']; ?>"/>
